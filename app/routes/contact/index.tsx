...
const ContactPage = ({actionData}:Route.ComponentProps) => {
    ...
    return ( <div className="max-w-3xl mx-auto px-6 py-8 bg-gray-900">
        <h2 className="text-3xl font-bold mb-8 text-center">
            Contact Me
        </h2>

        <form action='https://formspree.io/f/mykbkgrk' method="POST" className="space-y-6">
            <div>
                <label htmlFor="name" className="block text-sm font-md text-gray-300">Full Name</label>
            ...
            <div>
                <label htmlFor="email" className="block text-sm font-md text-gray-300">Email</label>
            ...
            <div>
                <label htmlFor="subject" className="block text-sm font-md text-gray-300">Subject</label>
            ...
            <div>
                <label htmlFor="message" className="block text-sm font-md text-gray-300">Message</label>
